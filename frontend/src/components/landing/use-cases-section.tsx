        ...
        >
          {industries.map((industry) => (
            <motion.article
              ...
              role="listitem"
              className="bg-brand-bg rounded-3xl p-8 transition-[background-color,box-shadow] duration-300 hover:shadow-xl hover:shadow-purple-900/5 hover:bg-brand-bg-2"
            >
