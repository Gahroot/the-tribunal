        ...
        >
          {metrics.map((metric) => (
            <motion.div
              ...
              role="listitem"
              className="text-center p-8 bg-white rounded-3xl transition-[background-color,box-shadow] duration-300 hover:shadow-xl hover:shadow-purple-900/5 hover:bg-[#f8f6fa]"
            >
              <metric.icon
