      ...
      >
        ...
        >
          {stats.map((stat) => (
            <motion.div
              key={stat.value}
              className="text-center p-8 bg-brand-bg rounded-3xl transition-[background-color,box-shadow] duration-300 hover:shadow-xl hover:shadow-purple-900/5 hover:bg-brand-bg-2"
