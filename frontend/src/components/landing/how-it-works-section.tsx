      ...
      >
        ...
        >
          {steps.map((step) => (
            ...
            >
              <div className="bg-brand-bg rounded-3xl p-10 h-full transition-[background-color,box-shadow] duration-300 hover:shadow-xl hover:shadow-purple-900/5 hover:bg-brand-bg-2">
                <div
