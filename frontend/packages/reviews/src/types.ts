// Domain types for the reviews & reputation block.
//
// These moved out of the app's `@/types/review` into the extracted
// `@tribunal/reviews` package so the package owns its own contract. The app's
// `@/types/review` re-exports from here to keep a single source of truth.
