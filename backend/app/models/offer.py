"""Back-compat shim for the ``Offer`` model.
...
* existing imports (``from app.models.offer import Offer``) keep working,
* importing this module registers the ``offers`` table in ``Base.metadata`` so
  ``app.db.model_registry.import_model_modules`` still discovers it for Alembic.
"""

from __future__ import annotations

from tribunal_offers.models import Offer
